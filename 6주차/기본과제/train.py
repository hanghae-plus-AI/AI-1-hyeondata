...
training_args.evaluation_strategy = "steps"  # 일정 스텝마다 evaluation 수행
training_args.eval_steps = 100  # 500 스텝마다 evaluation 진행
training_args.logging_steps = 100  # 100 스텝마다 로그 기록
...
trainer = Trainer(
    ...
    eval_dataset=eval_dataset, #validation 데이터셋 넣기
    tokenizer=tokenizer,
...
trainer.log_metrics("eval", final_eval_results)
trainer.save_metrics("eval", final_eval_results)
trainer.save_state()
